    ...
    <section className="relative pt-12 pb-24 px-4 sm:px-6 max-w-7xl mx-auto w-full overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start mb-16">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          {/* Tag */}
          <div className="mb-6 inline-flex items-center gap-2 px-3 py-1 bg-white/80 dark:bg-[#111]/80 backdrop-blur-md text-black dark:text-[#ccc] rounded-lg border border-[#e5e5e5] dark:border-[#222] font-mono text-[11px] shadow-xs">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8">
            <Link
              ...
              className="inline-flex items-center gap-3 px-7 py-4 bg-black hover:bg-[#111] dark:bg-white dark:hover:bg-[#f0f0f0] dark:text-black text-white font-bold rounded-xl text-sm transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 group"
            >
            ...
            <Link
              to="/playground"
              className="inline-flex items-center gap-2.5 px-6 py-4 glass-card-interactive text-black dark:text-white font-semibold rounded-xl text-sm transition shadow-xs hover:-translate-y-0.5"
            >
        ...
        <div className="lg:col-span-5 relative min-h-[460px] flex items-center justify-center pt-4">
          ...
          <div className="absolute inset-0 border border-dashed border-[#e5e5e5] dark:border-[#1a1a1a] rounded-3xl bg-white/40 dark:bg-[#0a0a0a]/40 backdrop-blur-sm -z-10" />

          {/* Floating Card 1: useState */}
          <div className="hero-floating-card-1 absolute top-2 left-0 sm:-left-4 z-10">
            <div className="w-60 sm:w-64 p-4 rounded-2xl glass-card-interactive cursor-pointer group hover:-translate-y-2 hover:scale-[1.03]">
              ...
              <h3 className="font-bold text-base text-black dark:text-white font-mono group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors duration-300">
                useState()
              </h3>
              ...
              <div className="mt-3 pt-2 border-t border-black/5 dark:border-white/5 flex items-center justify-between text-[11px] font-mono text-emerald-700 dark:text-emerald-400">
                <code>const [val, setVal]</code>
                <span className="text-[10px] bg-emerald-500/10 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 px-1.5 py-0.5 rounded font-bold border border-emerald-500/20">HOOK</span>
              </div>
            </div>
          </div>

          {/* Floating Card 2: useEffect */}
          <div className="hero-floating-card-2 absolute top-16 right-0 sm:-right-2 z-10">
            <div className="w-56 sm:w-60 p-4 rounded-2xl glass-card-interactive cursor-pointer group hover:-translate-y-2 hover:scale-[1.03]">
              <div className="flex items-center justify-between text-[10px] font-mono text-[#888] dark:text-[#666] mb-2 uppercase tracking-wider">
                <span>02 • SYNCHRONIZATION</span>
                <Zap className="w-3 h-3 text-amber-500" />
              </div>
              <h3 className="font-bold text-base text-black dark:text-white font-mono group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors duration-300">
                useEffect()
              </h3>
              <p className="text-xs text-[#666] dark:text-[#888] mt-1 leading-snug">
                Synchronize component logic with external browser APIs and timers.
              </p>
              <div className="mt-3 pt-2 border-t border-black/5 dark:border-white/5 text-[10px] font-mono text-[#888]">
          ...
          <div className="hero-floating-card-3 absolute bottom-14 left-4 sm:left-6 z-20">
            <div className="w-60 sm:w-64 p-4 rounded-2xl glass-card-interactive cursor-pointer group hover:-translate-y-2 hover:scale-[1.03]">
              <div className="flex items-center justify-between text-[10px] font-mono text-[#888] dark:text-[#666] mb-2 uppercase tracking-wider">
          ...
          <div className="hero-floating-card-4 absolute -bottom-2 right-2 sm:right-4 z-10">
            <div className="w-52 sm:w-56 p-3.5 rounded-2xl glass-card-interactive cursor-pointer group hover:-translate-y-2 hover:scale-[1.03]">
              ...
              <h4 className="font-bold text-sm text-black dark:text-white font-mono group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors duration-300">
                useContext()
              </h4>
          ...
          {/* Stamp Badge */}
          <div
            className="animate-badge-float absolute top-1/2 left-1/2 px-3.5 py-1.5 bg-black/90 text-white dark:bg-white/90 dark:text-black backdrop-blur-md border border-white/20 dark:border-black/20 rounded-xl text-[11px] font-mono font-bold shadow-xl pointer-events-none z-20"
          >
            ✦ PURE DECLARATIVE UI
          </div>
        </div>
