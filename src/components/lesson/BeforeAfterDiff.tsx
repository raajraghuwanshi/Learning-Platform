  ...
  return (
    <div className="glass-card rounded-2xl p-6 mb-8 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        ...
        <div className="flex gap-1 p-1 bg-black/[0.04] dark:bg-white/[0.06] rounded-xl border border-black/5 dark:border-white/10 text-xs">
          <button
      ...
      <div className={`grid gap-4 mb-4 ${activeTab === 'both' ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'}`}>
        {(activeTab === 'both' || activeTab === 'vanilla') && (
          <div className="p-4 bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/10 rounded-2xl">
